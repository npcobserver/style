# Instructions
## Notes
- A field enclosed within `« »` is either optional or must be filled with one of the given options, or both, depending on the context.
- The ✂️ emoji means the line or entry is optional.
- Abbreviate the months **if and only if** they precede days. Do NOT abbreviate May, June, or July, and abbreviate September as "Sept." Use three-letter abbreviations (followed by a `.`) for others.
- Use pages for bills passed during the 14th NPC for reference.
